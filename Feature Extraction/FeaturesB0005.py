...
plt.scatter(cycle_num5,signal_energy5, color='red')
plt.scatter(cycle_num5,fluctuation_index5, color='yellow')
plt.scatter(cycle_num5,skewness_index5, color='green')
plt.scatter(cycle_num5,kurtosis_index5, color='blue')
